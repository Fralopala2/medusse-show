    ...
    <Section id={id} className="relative bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-white flex items-center justify-center">
      <Container className="relative z-10 flex flex-col md:flex-row items-center gap-12">
        <motion.div
          ...
          className="flex-1"
        >
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-4 text-white drop-shadow-lg">{data.title}</h2>
          <p className="text-lg sm:text-xl text-white/90 mb-8 drop-shadow-md">{data.subtitle}</p>
        ...
        >
           ...
           <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1551288049-bebda4e38f71?q=80&w=2070&auto=format&fit=crop')] bg-cover bg-center opacity-20 mix-blend-overlay" />
           <div className="absolute inset-0 bg-black/50" />
           <div className="relative z-10 text-center p-8">
             <div className="text-5xl sm:text-6xl font-mono font-bold text-blue-400 mb-2 drop-shadow-lg">MQTT</div>
             <div className="text-xs sm:text-sm text-white uppercase tracking-widest drop-shadow-md">Protocolo Seguro</div>
           </div>
        </motion.div>
      </Container>
    </Section>
