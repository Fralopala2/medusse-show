...
**Nota importante:** MySQL en el host usa el puerto **13306** (mapeo `13306:3306` en docker-compose). En Windows, los puertos 3000–3307 suelen estar reservados por Hyper-V; ver [documentacion/PUERTOS.md](../documentacion/PUERTOS.md).
